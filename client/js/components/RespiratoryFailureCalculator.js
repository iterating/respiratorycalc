...
export class RespiratoryFailureCalculator {
    ...
    displayResult(result) {
        ...
        const hl7Btn = this.resultDiv.querySelector('.hl7-btn');
        ...
        hl7Btn.addEventListener('click', () => {
            const hl7Data = exportUtils.toHL7(result);
            exportUtils.downloadFile(hl7Data, 'respiratory-assessment-hl7.txt', 'text/plain');
        });
    }
